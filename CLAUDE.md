...
| Check-in & Offline | `src/lib/offline/**`, `src/app/api/tickets/checkin/**`, `src/utils/qr.ts`, `src/utils/haptics.ts`, `src/app/**/scanner/**`, `src/components/scanner/**`, `src/app/(admin)/door/**` |
