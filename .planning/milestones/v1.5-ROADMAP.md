---
milestone: v1.5
name: Platform Layout, Access Model & Door Fixes
status: archiviata CON DEBITO DICHIARATO — non "passed"
archived: "2026-08-19"
phases: 18
plans: 261
audit: .planning/v1.5-MILESTONE-AUDIT.md (gaps_found)
---

# v1.5 — Platform Layout, Access Model & Door Fixes

> **Come va letta questa milestone.** Tutti i 261 piani hanno un SUMMARY e ogni
> gate automatico del repository e' verde. **Nessuna delle diciotto verifiche di
> fase e' `passed`**: tredici sono `human_needed`, una `gaps_found`, e tre
> portano un verdetto in prosa. Cio' che manca non e' codice — e' osservazione.
>
> **Un criterio e' perso in modo permanente:** il criterio 3 della fase 42
> (`DS-04`/`RESP-05`) non ha piu' un termine di paragone, per deroga esplicita
> del proprietario del 2026-08-18 (`DEF-42-04`). Nessun documento deve contarlo
> fra i chiusi.
>
> **Requisiti: 14 chiusi su 76.** Gli altri 62 non sono contraddetti dal codice —
> aspettano che una persona li guardi. Sono archiviati **con il loro stato vero**,
> non spuntati: vedi `v1.5-REQUIREMENTS.md`.
>
> Il quadro completo sta in `.planning/v1.5-MILESTONE-AUDIT.md`, e le due sedute
> di laboratorio che hanno aggredito parte del debito in `v1.5-LAB-SITTING.md` e
> `v1.5-B1-B2-FINDINGS.md`.
