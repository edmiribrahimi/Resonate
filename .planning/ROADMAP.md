...
- [x] 41-18-PLAN.md — G2's fence and its debt list stop contradicting each other, and the rung family covers what the report claims
...
- [x] 42-09-PLAN.md — the forty-two legacy token aliases, longest name first, reconciled against the baseline

**Wave 6** *(BLOCKED)*

- [x] 42-10-PLAN.md — the scanner centres and the viewfinder centres, and the decode configuration does not move
...
- [x] 42-12-PLAN.md — the baseline re-run and diffed line by line, evidence at `file:line` per requirement, and criterion 3 stated as **open** until the door pass is re-run
...
| 42. Scanner Conversion | 12/12 | Executed, NOT complete — criterio 3 non chiudibile (DEF-42-04), 9 procedure `pending` | - |
