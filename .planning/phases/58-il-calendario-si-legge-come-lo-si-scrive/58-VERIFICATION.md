...
human_verification:
  - test: "Esercitare P-58-C (passi 1-7) — il rientro dall'istantanea dopo uno specchio interrotto"
    ...
    why_human: "CORRETTO IL 2026-08-25 — non e' l'autorizzazione a bloccare. Il frontmatter di 58-PROCEDURES.md dice «P-58-C legge soltanto», e la procedura: «non scrive in produzione con le proprie mani ... Non ha bisogno di un'autorizzazione propria». Cio' che blocca e' la PRECONDIZIONE — «lo specchio e' morto fra la cancellazione e la riscrittura» — e in produzione nessuna corsa e' morta a meta': tutte e sei le righe di production_import_run portano un finished_at, misurato dal catalogo. Un runbook di rientro non si esercita a comando su un incidente che non c'e'"
