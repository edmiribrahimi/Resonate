...
### La corsa «prima» di `P-51-1`, decisa il 2026-09-22
- **D-51-16 — La corsa «prima» si percorre in forma ridotta, e cita `P-50-8` per cio' che `P-50-8` ha gia' misurato.** Decisione del proprietario, alla domanda *«non l'abbiamo gia' fatta?»*. `P-50-8` (`50-ESITI.md`) e' stata percorsa dal proprietario il 2026-09-21 alle 16:01Z sul laboratorio, in modalita' aereo vera, **sullo stesso codice** che la corsa «prima» misurerebbe: biglietto accettato a radio spenta, seconda lettura non rifiutata e non contata due volte, coda drenata alla riaccensione, una riga sola in `door_scan_events`. Per quei passi la colonna «cosa si e' visto» della corsa «prima» **rimanda a `P-50-8` con la sua ora**, a condizione che il task 2 confermi che il laboratorio serve un commit senza modifiche alla porta rispetto a quella corsa. Si percorrono **davvero**, al telefono, solo i passi che `P-50-8` non ha toccato: l'invitato di guest list senza email presente per nome nella lista scaricata e fatto entrare a radio spenta; lo scorrimento della lista; e la **precondizione che solo il «prima» puo' produrre** — un codice socio scansionato a radio spenta e lasciato in coda, senza drenarla, perche' e' l'unica cosa che dopo l'aggiornamento non si puo' piu' costruire. La procedura resta scritta per intero, con i nove passi, perche' la corsa «dopo» li percorre tutti.
