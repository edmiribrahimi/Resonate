...
**Current Focus:** Fase 52 chiusa — prossima 52.1 (chiusura del debito della 52), poi 53 (TASK)
...
- [Phase 49]: Il preventivo di un ordine e' un **modulo `server-only`** e non un'esportazione di un file di Server Action: quel tipo di file pubblica **ogni** esportazione come endpoint, e una funzione che dice quanto costa e quanti posti restano diventerebbe un oracolo sull'inventario — senza rate limiting, che questo repo non ha
