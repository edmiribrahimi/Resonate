...
- **Gate autorizzazione per destinatario — RISCRITTO il 2026-08-22 (decisione del proprietario)**:
  ...
  **Cosa resta vietato:**
  ...
  - **Con o senza sessione, la stessa cosa** — decisione del proprietario, 2026-09-25: *«chi e' loggato e chi non lo e' deve vedere le stesse cose per quanto riguarda una secret venue»*. Il dialog e l'indizio sono gli stessi per tutti; l'indizio **non e' piu' dietro l'accesso**, e questo lo rende davvero pubblico — il gate *indizio non equivalente all'indirizzo* e' ora l'unica difesa. Il controllo **E4** di `verify:venue-surfaces` e' stato ripuntato sul termine di segretezza.
